...
We'll re-introduce the readme when we have an idea of what needs to be read.

== History

=== Version 0.8 (15 Jun 2010) ^DK
...
* DK and CR decide to make this the core for an entire shop extension
